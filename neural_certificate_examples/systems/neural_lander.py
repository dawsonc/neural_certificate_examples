...
class NeuralLander(ControlAffineSystem):
    ...
    def __init__(
        ...
        """
        super().__init__({}, dt, controller_dt)
    ...
    def state_limits(self) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        upper_limit[NeuralLander.PX] = 1.0
        upper_limit[NeuralLander.PY] = 1.0
        upper_limit[NeuralLander.PZ] = 1.0
    ...
    def _f(self, x: torch.Tensor, params: Scenario):
        ...
        f = torch.zeros((batch_size, self.n_dims))
        f = f.type_as(x)
        ...
        return f.reshape(batch_size, self.n_dims, 1)
