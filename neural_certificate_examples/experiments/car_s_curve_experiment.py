...
from neural_certificate_examples.systems import STCar

if TYPE_CHECKING:
    from neural_certificate_examples.controllers import Controller  # noqa
...
class CarSCurveExperiment(Experiment):
    ...
    def run(self, controller_under_test: "Controller") -> pd.DataFrame:
        ...
        ), "Controller must have an STCar dynamics model"
